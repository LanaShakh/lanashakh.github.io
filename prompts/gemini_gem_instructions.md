...
- Overall FPR: below 1% across major benchmarks
- These are our strongest results. Use when discussing accuracy, benchmarks, or comparisons. Skip for unrelated topics. Never name competitors — say "other detectors".
